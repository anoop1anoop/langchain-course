...
def main():
    ...
    summary_template = """
        ...
        2. Three interesting facts about the person
       
        Do not include any information that is not in the given information.
        Mention the name of the person in the summary and facts.  
    """
